...
export default function SocialMediaEmail(props: { finishedLoading: boolean, delta }) {
  return (
    <>
      <motion.div
        initial={{ y: "100%" }}
        animate={{ y: "0%" }}
        transition={{ y: { delay: props.finishedLoading ? 0 : 3 + props.delta, duration: props.finishedLoading ? 0 : 0.5 } }}
      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/angusleehs/"} />
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/drunkint"} />
            {/* Instagram Icon */}
            <IconClickableWithAnimation Icon={InstagramIcon} href={"https://www.instagram.com/angus_writes_stuff/"} />
            {/* Youtube Icon */}
          ...
          >
            <a href="mailto:abdellatif@anaflous.com" target={"_blank"} rel="noreferrer">
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                hsushen.lee<span className="text-AAsecondary">@</span>mail.utoronto<span className="text-AAsecondary">.</span>ca
              </span>
            </a>
          </motion.div>
