        ...
        <div className="w-full flex flex-col md:flex-row space-y-8 md:space-y-0  md:space-x-8 sm:space-x-2 ">
          <div className="w-full md:w-7/12 space-y-4 sm:text-md text-md ">
            ...
            <div className="font-Header ">
              ...
              <br/><br/>
              I honed my skills at the <span className="text-AAsecondary"> <a href="https://www.utoronto.ca/" target={"_blank"} rel="noreferrer" >University of Toronto</a></span>, where I consistently made the <span className="text-AAsecondary">Dean’s List</span>. 
