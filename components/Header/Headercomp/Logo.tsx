...
export default function Logo(props: { finishedLoading: boolean, delta: number }) {
  return (
    <>
      <motion.div
        ...
        transition={{
          type: "spring",
          y: { delay: props.finishedLoading ? 0 : 0 + props.delta, duration: 0 },
          opacity: { delay: props.finishedLoading ? 0 : 0 + props.delta, duration: 0 },
        }}
