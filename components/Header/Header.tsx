...
const Header = (props: { finishedLoading: boolean,sectionsRef, delta: number }) => {
  ...
  return (
    <>
      ...
      <motion.div
        ...
        transition={{ opacity: { delay: props.finishedLoading ? 0 : 1 + props.delta, duration: 0 } }}
      ...
      >
        {/* Logo A */}
        <Logo finishedLoading={props.finishedLoading} delta={props.delta} />
        ...
        <DesktopMenu finishedLoading={props.finishedLoading} delta={props.delta} />
      </motion.div>
    </>
  );
};
